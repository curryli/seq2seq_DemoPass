...
#使用多个buckets 会报错TypeError: can't pickle _thread.lock objects 
#buckets = [(120, 30), (200, 35), (300, 40), (400, 40), (500, 40)]
#如果想用多个bucket，可以尝试下面一段代码,我试过可以，不过加载的时候稍微慢一点，加载完了好像速度还可以。
...
def create_model(session, forward_only):
  ...
  #判断FLAGS.train_dir是否有已经训练好的模型,如果有，则再此基础之上进行训练
